    ...
    <div class="col-md-4">
      <?php
        if(isset($_POST['decifrar'])){
          ...
          $id = $_POST['id'];
          $clave = $_POST['contra'];
          $sql = "SELECT * FROM `aes` WHERE id = '$id' AND contra = '$clave'; ";
          ...
          <h3>Domicilio:<?php echo decifrar($row['domicilio'],$clave)?></h3></br>
          <h3>Identificación:<?php echo decifrar($row['identificacion'],$clave)?></h3></br><?php
          }
        }else{ 
       ?>
      <h3>Nombre:</h3></br>
